...
import com.ggsoftware.opcserver.services.DetalheUsuarioServiceImpl;
...
public class JWTConfiguracao extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests().antMatchers(HttpMethod.POST, "/login").permitAll()
				...
				.antMatchers("/v2/api-docs", "/configuration/ui", "/swagger-resources/**", "/configuration/**", "/swagger-ui/index.html", "/webjars/**", "/swagger-ui/**").permitAll()
